...
const articles: Article[] = [
  ...
  },
  {
    ...
    description: "Как заставить ИИ рассуждать шаг за шагом для решения сложных задач",
    content: "Chain-of-Thought (CoT) - это техника, при которой вы просите модель показать ход своих рассуждений перед тем, как дать окончательный ответ.\n\n## Пример использования:\n\n```\nВопрос: У Маши было 15 яблок. Она отдала 3 яблока Пете, а потом купила ещё 7. Сколько яблок у Маши?\n\nПожалуйста, реши задачу пошагово:\n1. Сначала у Маши было 15 яблок\n2. Она отдала 3 → 15 - 3 = 12\n3. Купила ещё 7 → 12 + 7 = 19\n\nОтвет: 19 яблок\n```\n\n## Когда использовать:\n- Математические задачи\n- Логические рассуждения\n- Анализ текста\n- Планирование действий",
